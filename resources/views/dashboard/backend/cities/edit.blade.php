...
@section('title' , __('models.edit_city')  )
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.edit_city') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.edit_city') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" id="createCustomerForm"
                                    action="{{ route('admin.cities.update' , $city->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <select class="select1 form-control" id="country_id" name="country_id">
                                                    ...
                                                    @foreach ($countries as $city )
                                                     <option value="{{$city->id}}" {{ $city->id == old('country_id') ? 'selected' : '' }}>{{  $city->name }}</option>
                                                   @endforeach
