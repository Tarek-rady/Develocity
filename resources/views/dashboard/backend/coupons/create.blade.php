...
@section('title' , __('models.add_coupon')  )
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.add_coupon') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.add_coupon') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" id="createCustomerForm"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                ...
                                                <input type="date" id="fp-default" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" name="expiry_date" value="{{ old('expiry_date') }}"  />
