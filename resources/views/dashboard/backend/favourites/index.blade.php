                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($fav->customer->img)
                                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="top" title="" class="avatar pull-up my-0" data-original-title="{{ $fav->customer->name }}">
                                                            <img src="{{ asset('storage/'. $fav->customer->img) }}" alt="Avatar" height="50" width="50" />
                                                        </div>
                                                    @else
                                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="top" title="" class="avatar pull-up my-0" data-original-title="{{ $fav->customer->name }}">
