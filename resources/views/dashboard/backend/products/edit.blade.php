                                    ...
                                    <form class="form form-vertical needs-validation" id="createCustomerForm"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                ...
                                                <textarea class="form-control editor"id="desc" name="desc" >{{ old('desc' , $product->desc) }}</textarea>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    <select class="select1 form-control" id="tag_id" name="tag_id">
                                                        <option value="{{ $product->tag_id ?  $product->tag_id : '' }}">{{ $product->tag_id ? $product->tag->name : '' }}</option>
